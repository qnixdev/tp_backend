...
@Entity
@Table(name = "measure")
public class Measure extends AbstractReferenceEntity {
    @Id
    @Column(name = "id", nullable = false)
    @GeneratedValue(strategy = GenerationType.UUID)
    private UUID id;

    @OneToMany(targetEntity = TradeItemReferenceData.class, mappedBy = "measure", cascade = {CascadeType.PERSIST, CascadeType.REMOVE}, orphanRemoval = true)
