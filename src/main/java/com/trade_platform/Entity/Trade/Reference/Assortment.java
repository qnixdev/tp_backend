...
public class Assortment extends AbstractReferenceEntity {
    @Id
    @Column(name = "id", nullable = false)
    @GeneratedValue(strategy = GenerationType.UUID)
    private UUID id;

    @OneToMany(targetEntity = TradeItemReferenceData.class, mappedBy = "assortment", cascade = {CascadeType.PERSIST, CascadeType.REMOVE}, orphanRemoval = true)
